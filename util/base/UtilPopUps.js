    ...
    return {
          validarRespuestaServicio: function(oAuditResponse, mensaje2) {
      			if (oAuditResponse.iCode === 1) {
      				this.onMessageSuccessDialogPress(oAuditResponse.sTransaccionId, mensaje2);
      			} else if (oAuditResponse.iCode === 200) {
                mensaje2 = "Ocurrio un problema con el registro pongase en contacto con soporte tecnico.";
              ...
              //mensaje2 = "Ocurrio un problema con el registro pongase en contacto con soporte tecnico.";
              mensaje2 = oAuditResponse.sMessage;
      				this.onMessageWarningDialogPress(oAuditResponse.sTransaccionId, mensaje2);
